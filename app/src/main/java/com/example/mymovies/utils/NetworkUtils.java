...
public class NetworkUtils {
    ...
    private static final String API_KEY = "ab32d14ff19656193459afda4ed81488";
    ...
    public static JSONObject getJSONForVidoes(int id, String lang) {
    ...
    public static class JSONLoader extends AsyncTaskLoader<JSONObject> {
        ...
        private OnStartLoadingListenter onStartLoadingListenter;

        public interface OnStartLoadingListenter {
            void onStartLoading();
        }

        public void setOnStartLoadingListenter(OnStartLoadingListenter onStartLoadingListenter) {
            this.onStartLoadingListenter = onStartLoadingListenter;
        }
        ...
        protected void onStartLoading() {
            ...
            if (onStartLoadingListenter != null) {
                onStartLoadingListenter.onStartLoading();
            }
            forceLoad();
        }
