...
public class JSONUtils {
    ...
    public static ArrayList<Review> getReviewsForMovie(JSONObject jsonObject) {
    ...
    public static ArrayList<Trailer> getTrailersForMovie(JSONObject jsonObject) {
        ...
        try {
            ...
            for (int i=0; i < jsonArray.length(); i++) {
                ...
                String key = BASE_YOUTUBE_URL + json.getString(KEY_KEY_OF_VIDEO);
